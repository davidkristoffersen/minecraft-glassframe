...
| Pack | What | Download |
|---|---|---|
| [GlassFrame](glassframe/) | Glass with no borders at all, blocks and panes, so a window or floor reads as one clean sheet. Pairs with a plugin that draws the outline back only where the glass actually stops. | [`GlassFrame-2.8.0-borderless.zip`](glassframe/GlassFrame-2.8.0-borderless.zip) |
